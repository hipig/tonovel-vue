<template>
  <div class="flex items-center">
    <div class="flex-1 pr-2 sm:pr-6">
      <input type="text" v-model="searchValue" class="appearance-none block w-full py-3 px-4 leading-none sm:leading-normal border placeholder-gray-500 rounded-lg focus:outline-none focus:shadow-outline-blue focus:z-10 sm:px-5 text-sm sm:text-lg" placeholder="请输入小说名称，作者，标签..." @keyup.enter="search" @input="updateSearchValue">
    </div>
